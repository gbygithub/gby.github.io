(function() {
  ...
  callWithJQuery(function($) {
    ...
    pivotTableRenderer = function(pivotData, opts) {
      ...
      result.style.borderSpacing = 0 //cdh 2016-12-23 添加行内样式，消除表格间隙，为打印做准备
      ...
      for (j in colAttrs) {
        ...
        if (parseInt(j) === 0 && rowAttrs.length !== 0) {
          ...
          th.style.border = "1px solid #CDCDCD";//cdh 2016-12-23 为元素添加行内样式，供打印使用
      ...
      for (i in rowKeys) {
        ...
        for (j in colKeys) {
          ...
          td.style.border = "1px solid #CDCDCD";//cdh 2016-12-23 为元素添加行内样式，供打印使用

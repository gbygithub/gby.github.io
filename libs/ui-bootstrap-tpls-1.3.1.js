...
.directive('uibTab', ['$parse', function($parse) {
  return {
    ...
    scope: {
      ...
      index: '=?',
      classes: '@?',
      // shownav: '=', //cdh 2016-11-18 Controls whether navigation is displayed
...
angular.module("uib/template/tabs/tab.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/tabs/tab.html",
    ...
    // "  <a href ng-if=\"shownav\" ng-click=\"select($event)\" class=\"nav-link\" uib-tab-heading-transclude>{{heading}}</a>\n" +
    "</li>\n" +
    "");
    // cdh  2016-11-18 The ng-if attribute is added to control the navigation display state
}]);
